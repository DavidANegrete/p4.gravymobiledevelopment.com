...
# What is the name of this app?
	define('APP_NAME', 'Dlicious Nails App');

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'danegrete79@gmail.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'bestService_@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'p4_gravymobiledevelopment_com');
...
# For extra security, you might want to set different salts than what the core uses
    define('PASSWORD_SALT', 'd3@rH@ck3rPl3@$3L3@v3MyU$3r@lon3');
	define('TOKEN_SALT', 'd3@rH@ck3rPl3@$3L3@v3MyU$3r@lon3');